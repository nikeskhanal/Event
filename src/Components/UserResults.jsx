...
import { Award, UserCheck, Medal, ArrowLeftCircle } from 'lucide-react'; // Importing icons from lucide-react
    ...
    <div>
      ...
      <div className="container mx-auto p-8 bg-gray-50 rounded-lg shadow-lg">
        ...
        <button
          ...
          className="flex items-center gap-3 px-6 py-3 text-lg font-medium text-white bg-gray-600 rounded-lg hover:bg-gray-700 transition transform hover:scale-105 shadow-md mb-6"
        >
